            ...
            <div className="flex flex-col gap-4 mt-4">
                {data[0] && (
                    <div className="bg-schoolSkyLight rounded-md p-4">
                        ...
                        <p className="text-sm to-gray-400 mt-1">{data[0].description}</p>
                    </div>
                )}
                {data[1] && (
                    <div className="bg-schoolPurpleLight rounded-md p-4">
                        ...
                        <p className="text-sm to-gray-400 mt-1">{data[1].description}</p>
                    </div>
                )}
                {data[2] && (
                    <div className="bg-schoolYellowLight rounded-md p-4">
                        ...
                        <p className="text-sm to-gray-400 mt-1">{data[2].description}</p>
                    </div>
                )}
            </div>
        </div>
