                ...
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        <Link
                            ...
                            href={`/list/classes?supervisorId=${'teacher'}`}
                        >
                            Teacher&apos;s Classes
                        </Link>
                        <Link
                            className="p-3 rounded-md bg-schoolPurpleLight"
                            href={`/list/students?teacherId=${'teacher'}`}
                        >
                            Teacher&apos;s Students
                        </Link>
                        <Link
                            className="p-3 rounded-md bg-schoolYellowLight"
                            href={`/list/lesson?teacherId=${'teacher'}`}
                        >
                            Teacher&apos;s Lessons
                        </Link>
                        <Link className="p-3 rounded-md bg-pink-50" href={`/list/exams?teacherId=${'teacher'}`}>
                            Teacher&apos;s Exams
                        </Link>
                        <Link
                            className="p-3 rounded-md bg-schoolSkyLight"
                            href={`/list/assignments?teacherId=${'teacher'}`}
                        >
