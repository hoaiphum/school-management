...
export const createTeacher = async (currentState: CurrentState, data: TeacherSchema) => {
    try {
        const clerkClients = await clerkClient();
        const user = await clerkClients.users.createUser({
...
export const updateTeacher = async (currentState: CurrentState, data: TeacherSchema) => {
    ...
    try {
        const clerkClients = await clerkClient();
        const user = await clerkClients.users.updateUser(data.id, {
            username: data.username,
...
export const deleteTeacher = async (currentState: CurrentState, data: FormData) => {
    ...
    try {
        const clerkClients = await clerkClient();
        const user = await clerkClients.users.deleteUser(id);
